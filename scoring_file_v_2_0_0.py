...
data_sample = PandasParameterType(pd.DataFrame({"PetalLengthCm": pd.Series([0.0], dtype="float64"), "PetalWidthCm": pd.Series([0.0], dtype="float64"), "SepalLengthCm": pd.Series([0.0], dtype="float64"), "SepalWidthCm": pd.Series([0.0], dtype="float64")}))
